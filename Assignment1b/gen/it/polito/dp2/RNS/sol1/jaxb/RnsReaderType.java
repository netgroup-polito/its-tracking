 ...
 *         &lt;element name="place" type="{http://www.example.org/RnsInfo}SimplePlaceReaderType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class RnsReaderType {
    ...
    protected List<SimplePlaceReaderType> place;
     ...
     * 
     */
    public List<SimplePlaceReaderType> getPlace() {
        if (place == null) {
            place = new ArrayList<SimplePlaceReaderType>();
        }
        return this.place;
    }
