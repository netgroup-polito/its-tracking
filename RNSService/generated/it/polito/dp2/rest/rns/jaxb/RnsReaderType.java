 ...
 *         &lt;element name="road" type="{http://www.example.org/RnsInfo}RoadReaderType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class RnsReaderType {
    ...
    protected List<RoadReaderType> road;
     ...
     * 
     */
    public List<RoadReaderType> getRoad() {
        if (road == null) {
            road = new ArrayList<RoadReaderType>();
        }
        return this.road;
    }
